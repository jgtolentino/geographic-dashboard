...
-- Insert sample sales data (June-July 2025)
...
CREATE INDEX idx_clean_events_event_ts ON silver.clean_events(event_ts);
CREATE INDEX idx_clean_events_store_brand ON silver.clean_events(store_id, brand_name);
CREATE INDEX idx_clean_events_category ON silver.clean_events(product_category);
